...
class DisplayDiagnosisViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if diagnosisLabel.text == "Malignant" || diagnosisLabel.text == "The mole present may be abnormal"
        { diagnosisLabel.text = "The mole present may be abnormal"
            ...
            diagnosisLabel.text = "The mole present appears to be normal"
            diagnosisSubLabel.textColor = #colorLiteral(red: 0.3665700024, green: 0.7417052292, blue: 0.4350099593, alpha: 1)
            diagnosisSubLabel.text = "We still recommend you contact a dermatologist for an evaluation if concerns about your mole persist. If you believe there has been a mistake, please contact our team."
